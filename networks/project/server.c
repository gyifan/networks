 ...
 * Project 2 - Stop-and-go Protocol
 * 04/25/2014
 * Yifan Ge
 *
 ...
 * 	udp-server.c
 *
 * This is a server sent for stop-and-go protocol.
 *   It wait for the client send a file name. Then it will make a file 
 *   and copy the rest packet data to that file.
 *
 */
